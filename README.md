...
- 🔭 Currently exploring: **Digital Signal Processing (DSP)** and **Machine Learning** applied to Electronics.
- ⚙️ Bridging the gap: Using **Python** to enhance engineering workflows (**SPICE tools** integration, automation scripts).
- 🕹️ Fun project: Revisiting **C** and building graphical experiments with **Raylib**.
- 🐧 Deeply interested in: **Linux**, Bash scripting, Containers, and how Operating Systems work under the hood.
...
- 🏋️‍♂️ Gym enthusiast.
- 🎮 Retro gaming and vintage tech collector.
- 📖 Interested in Philosophy, Comics (HQs), Manga, and Anime.
- 🎬 Movie and series buff.
